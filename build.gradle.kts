...
dependencies {
    ...
    implementation(group = "com.timoliacreative", name = "tranclate", version = "2.6.0.19")
    implementation(group = "com.timoliacreative", name = "tranclate-std-lib", version = "0.8.0.7")
