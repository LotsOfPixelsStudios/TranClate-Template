...
dependencies {
    ...
    implementation(group = "com.timoliacreative", name = "tranclate", version = "2.3.0.26")
    implementation(group = "com.timoliacreative", name = "tranclate-std-lib", version = "0.6.0.11")
